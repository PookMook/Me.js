  ...
  render() {
    return (
      <article className="card">
          ...
          {this.props.object.exemples ? <ul>Exemples : {this.props.object.exemples.map((o,i)=>(<li key={"exemple"+this.props.index+"-"+i}><a href={o} target="_blank"className="list">{o}</a></li>))}</ul> : ''}
